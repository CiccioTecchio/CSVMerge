#!/bin/bash
python3 Main.py mondiale.csv ds.csv 6
python3 Main.py election_day_tweets_US.csv ds.csv 0
python3 Main.py TweetsAustralianElection2019.csv ds.csv 2
python3 Main.py dem_vs_rep.csv ds.csv 2
...
python3 Main.py medical_speech.csv ds.csv 10
python3 Main.py mtsamples.csv ds.csv 1
python3 Main.py mtsamples.csv ds.csv 4
